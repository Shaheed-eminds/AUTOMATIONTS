...
Scenario Outline: Check for mandatory fields validations
 //  When I try to continue without filling in the personal details screen
  ...
  //  Examples:
      | fullName | email              | country | state     | city      | employmentType | department  | role                      | reportingManager | remote | timezone       | healthPlan | dependentsCount | dependent1 | dependent2 | retirementPct | successHeading   | successMessage                          | submissionIdPrefix |
      |  |                            | India   | Karnataka | Bengaluru | full-time      | Engineering | Site Reliability Engineer | Morgan Lee        | yes    | IST (UTC+5:30) | Basic      | 2               | Riya Kim   | Dev Kim    | 5             | You're all set! | The onboarding record has been created. | OB                  |


// with employmentType= Contract
Scenario Outline: Complete form for Employment type as Intern
    ...
    Examples:
      | fullName | email              | country | state     | city      | employmentType | Months | department  | role                      | reportingManager | remote | timezone       | healthPlan | dependentsCount | dependent1 | dependent2 | retirementPct | successHeading   | successMessage                          | submissionIdPrefix |
      | Alex Kim | alex.kim@test.com  | India    | Karnataka  | Bengaluru  | intern    |  | Engineering | Site Reliability Engineer | Morgan Lee        | yes    | IST (UTC+5:30) | Basic      | 2               | Riya Kim   | Dev Kim    | 5             | You're all set! | The onboarding record has been created. | OB                  |
